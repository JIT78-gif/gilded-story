...
const CountdownTimer = () => {
  ...
  return (
    <section className="py-28 md:py-36 px-6">
      ...
      >
        <p className="font-body text-fluid-lg tracking-[0.2em] uppercase text-muted-foreground mb-12 leading-relaxed">
              ...
              <div className="relative w-20 h-20 md:w-28 md:h-28 lg:w-32 lg:h-32">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <motion.span
                    ...
                    className="font-heading text-fluid-2xl text-foreground"
                  >
                    {String(unit.value).padStart(2, "0")}
                  </motion.span>
                </div>
              </div>
              <p className="font-body text-fluid-sm text-muted-foreground mt-3 tracking-wider uppercase">
                {unit.label}
              </p>
            </motion.div>
          ))}
